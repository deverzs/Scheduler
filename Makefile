...
SRCS = schedule_fcfs.cpp schedule_rr.cpp schedule_sjf.cpp schedule_priority.cpp \
	PCB.cpp ReadyQueue.cpp # .c or .cpp source files.
...
priority: schedule_priority.o PCB.o ReadyQueue.o
	$(CC) -o priority schedule_priority.o PCB.o ReadyQueue.o $(LDFLAGS) $(LIB)
